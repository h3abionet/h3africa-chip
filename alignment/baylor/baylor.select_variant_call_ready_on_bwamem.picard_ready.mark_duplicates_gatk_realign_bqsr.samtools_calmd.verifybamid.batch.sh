...
verifybamid_persample_stats_list=baylor.select_variant_call_ready_on_bwamem.picard_ready.mark_duplicates_gatk_realign_bqsr.samtools_calmd.verifybamid.batch.verifyBamID_stats_list
